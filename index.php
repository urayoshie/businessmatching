        ...
        <section class="program" id="program">
            <div class="program__container">
                ...
                <ul>
                    <li>
                        <a href="<?php echo home_url('/#new-event1'); ?>">
                            <div class="program__container__box">
                                ...
                                <div>
                                    <p class="category">第1回</p>
                                    <p class="name">協業マッチングイベント<br>「建設DX」</p>
                                </div>
                    ...
                    <li>
                        <div class="program__container__box">
                            <div class="program__container__img">
                                <p class="title">Matching Event</p>
                                <div style="position: relative; z-index: 1;">
                                    <p style="margin: 0 auto;" class="date">2025年 <span>11月下旬</span></p>
                                </div>
                                <div>
                ...
                <div class="new-seminar-event__wrapper">
                    <div class="new-seminar-event__content">
                        ...
                        <div class="new-seminar-event__content__thema__title">
                            <p class="new-seminar-event__content__thema">第１回&ensp;<br class="pc-none">協業マッチングイベント<br>「建設DX」</p>
                        </div>
                        ...
                        <div class="new-seminar-event__content__speaker">
                            <p class="new-seminar-event__content__speaker__title">登壇企業</p>
